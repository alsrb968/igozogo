...
class SyncAndGetFeedsUseCaseUnitTest {
    ...
    private lateinit var usecase: SyncAndGetFeedsUseCase

    @Before
    fun setup() {
        Dispatchers.setMain(testDispatcher)
        usecase = SyncAndGetFeedsUseCase(
    ...
    companion object {
        ...
        private val testCategories = List(10) { "Category $it" }
        private val testPlaces = List(10) { testPlace }
